...
//Forming Press
mods.gregtech.FormingPress.addRecipe(<appliedenergistics2:item.ItemMultiMaterial:20>, <gregtech:gt.metaitem.01:17020>, <appliedenergistics2:item.ItemMultiMaterial:19>, 200, 16);

//Wood Gear Ore Dict
<ore:gearWood>.remove(<appliedenergistics2:item.ItemMultiMaterial:40>);
NEI.hide(<appliedenergistics2:item.ItemMultiMaterial:40>);

//Silicon Ore Dict
<ore:itemSilicon>.remove(<appliedenergistics2:item.ItemMultiMaterial:5>);
NEI.hide(<appliedenergistics2:item.ItemMultiMaterial:5>);
<ore:dustIron>.remove(<appliedenergistics2:item.ItemMultiMaterial:49>);
<ore:dustAnyIron>.remove(<appliedenergistics2:item.ItemMultiMaterial:49>);
NEI.hide(<appliedenergistics2:item.ItemMultiMaterial:49>);
<ore:nuggetIron>.remove(<appliedenergistics2:item.ItemMultiMaterial:50>);
<ore:nuggerAnyIron>.remove(<appliedenergistics2:item.ItemMultiMaterial:50>);
NEI.hide(<appliedenergistics2:item.ItemMultiMaterial:50>);
<ore:dustGold>.remove(<appliedenergistics2:item.ItemMultiMaterial:51>);
NEI.hide(<appliedenergistics2:item.ItemMultiMaterial:51>);
...
[<ore:plateTitanium>, AdvCircuit, <ore:plateTitanium>]]);
...
[<gregtech:gt.metaitem.01:32681>, EnderEyeRod, <gregtech:gt.metaitem.01:32681>],
...
[<ore:plateTitanium>, <appliedenergistics2:item.ItemMultiMaterial:22>, <ore:plateTitanium>],
...
[<ore:plateGlass>, <gregtech:gt.blockmachines:24>, <ore:plateGlass>],
[<ore:plateTitanium>, <ore:plateGlass>, <ore:plateTitanium>]]);
...
//Cable Anchor
recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotIron>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotCopper>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 3, [Knife, <ore:ingotBronze>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotTin>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotIron>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 4, [Knife, <ore:ingotSteel>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 4, [Knife, <ore:ingotAluminium>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotLead>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotNickel>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 2, [Knife, <ore:ingotSilver>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 3, [Knife, <ore:ingotBrass>]);

recipes.addShapeless(<appliedenergistics2:item.ItemMultiPart:120> * 3, [Knife, <ore:ingotInvar>]);
